...
function calc() {
  ...
  // 2 Проверяем если в локалсторач есть обьект ратио то в переменнную ратио передаем значение
  //если нету то приписываем значение и передаем его в локалсторач
  ...
  // 3 Проверяем если в локалсторач есть обьект секс то в переменнную ратио передаем значение
  //если нету то приписываем значение и передаем его в локалсторач
  ...
  // 4 Функция которая перебирает детей и для всех убирает класс активности и проверяет если елемент содержит дата ратио равняется
  // значению из локалсториджа то добавляет класс активности
  ...
  // 5 Главная функция которая считает по формуле
  function calcTotal() {
  ...
  // 6 Функция которая получает информацию из ратио
  ...
  // 7 Функция которая получет инфу с инпутов
...
document.addEventListener("DOMContentLoaded", () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)(), 3000);

  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]', '.modal', modalTimerId);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2023-11-22');
